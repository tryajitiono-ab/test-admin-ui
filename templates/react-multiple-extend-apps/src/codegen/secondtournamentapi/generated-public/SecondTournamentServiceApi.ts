...
import { SecondTournamentService$ } from './endpoints/SecondTournamentService$.js'

export function SecondTournamentServiceApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
  ...
  async function getTournaments(queryParams?: {
    ...
    const $ = new SecondTournamentService$(axiosInstance, namespace, useSchemaValidation)
