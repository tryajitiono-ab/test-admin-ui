...
export class TournamentService$ {
  ...
  getTournaments(queryParams?: {
    ...
    const url = '/ext-spaceshooter-mygame-tournament-system/v1/public/namespace/{namespace}/tournaments'.replace(
      '{namespace}',
      this.namespace
    )
  ...
  getTournament_ByTournamentId(tournamentId: string): Promise<Response<TournamentGetTournamentResponse>> {
    ...
    const url = '/ext-spaceshooter-mygame-tournament-system/v1/public/namespace/{namespace}/tournaments/{tournamentId}'
  ...
  getMatches_ByTournamentId(
    ...
    const url = '/ext-spaceshooter-mygame-tournament-system/v1/public/namespace/{namespace}/tournaments/{tournamentId}/matches'
      .replace('{namespace}', this.namespace)
      .replace('{tournamentId}', tournamentId)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  createRegister_ByTournamentId(
    ...
    const params = {} as AxiosRequestConfig
    const url = '/ext-spaceshooter-mygame-tournament-system/v1/public/namespace/{namespace}/tournaments/{tournamentId}/register'
      .replace('{namespace}', this.namespace)
      .replace('{tournamentId}', tournamentId)
  ...
  getParticipants_ByTournamentId(
    ...
    const params = { ...queryParams } as AxiosRequestConfig
    const url = '/ext-spaceshooter-mygame-tournament-system/v1/public/namespace/{namespace}/tournaments/{tournamentId}/participants'
      .replace('{namespace}', this.namespace)
      .replace('{tournamentId}', tournamentId)
    const resultPromise = this.axiosInstance.get(url, { params })
  ...
  getMatche_ByTournamentId_ByMatchId(tournamentId: string, matchId: string): Promise<Response<TournamentGetMatchResponse>> {
    const params = {} as AxiosRequestConfig
    const url = '/ext-spaceshooter-mygame-tournament-system/v1/public/namespace/{namespace}/tournaments/{tournamentId}/matches/{matchId}'
      .replace('{namespace}', this.namespace)
      .replace('{tournamentId}', tournamentId)
