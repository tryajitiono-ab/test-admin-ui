...
this.useSchemaValidation = useSchemaValidation
  ...
  createTournament(data: TournamentServiceCreateTournamentBody): Promise<Response<TournamentCreateTournamentResponse>> {
    ...
    const url = '/ext-abtesttryaji2026033001-xdd-tournmanet-system-local2/v1/admin/namespace/{namespace}/tournaments'.replace('{namespace}', this.namespace)     
  ...
  createStart_ByTournamentId(tournamentId:string, data: TournamentServiceStartTournamentBody): Promise<Response<TournamentStartTournamentResponse>> {
    const params = {} as AxiosRequestConfig
    const url = '/ext-abtesttryaji2026033001-xdd-tournmanet-system-local2/v1/admin/namespace/{namespace}/tournaments/{tournamentId}/start'.replace('{namespace}', this.namespace).replace('{tournamentId}', tournamentId)     
    const resultPromise = this.axiosInstance.post(url, data, {params})
  ...
  createCancel_ByTournamentId(tournamentId:string, data: TournamentServiceCancelTournamentBody): Promise<Response<TournamentCancelTournamentResponse>> {
    const params = {} as AxiosRequestConfig
    const url = '/ext-abtesttryaji2026033001-xdd-tournmanet-system-local2/v1/admin/namespace/{namespace}/tournaments/{tournamentId}/cancel'.replace('{namespace}', this.namespace).replace('{tournamentId}', tournamentId)     
    const resultPromise = this.axiosInstance.post(url, data, {params})
  ...
  createActivate_ByTournamentId(tournamentId:string, data: TournamentServiceActivateTournamentBody): Promise<Response<TournamentActivateTournamentResponse>> {
    const params = {} as AxiosRequestConfig
    const url = '/ext-abtesttryaji2026033001-xdd-tournmanet-system-local2/v1/admin/namespace/{namespace}/tournaments/{tournamentId}/activate'.replace('{namespace}', this.namespace).replace('{tournamentId}', tournamentId)     
    const resultPromise = this.axiosInstance.post(url, data, {params})
  ...
  deleteParticipant_ByTournamentId_ByUserId(tournamentId:string, userId:string): Promise<Response<TournamentRemoveParticipantResponse>> {
    const params = {} as AxiosRequestConfig
    const url = '/ext-abtesttryaji2026033001-xdd-tournmanet-system-local2/v1/admin/namespace/{namespace}/tournaments/{tournamentId}/participants/{userId}'.replace('{namespace}', this.namespace).replace('{tournamentId}', tournamentId).replace('{userId}', userId)     
  ...
  createResult_ByTournamentId_ByMatchId(tournamentId:string, matchId:string, data: TournamentServiceSubmitMatchResultBody): Promise<Response<TournamentSubmitMatchResultResponse>> {
    const params = {} as AxiosRequestConfig
    const url = '/ext-abtesttryaji2026033001-xdd-tournmanet-system-local2/v1/admin/namespace/{namespace}/tournaments/{tournamentId}/matches/{matchId}/result'.replace('{namespace}', this.namespace).replace('{tournamentId}', tournamentId).replace('{matchId}', matchId)     
    const resultPromise = this.axiosInstance.post(url, data, {params})
  ...
  createResultAdmin_ByTournamentId_ByMatchId(tournamentId:string, matchId:string, data: TournamentServiceAdminSubmitMatchResultBody): Promise<Response<TournamentAdminSubmitMatchResultResponse>> {
    const params = {} as AxiosRequestConfig
    const url = '/ext-abtesttryaji2026033001-xdd-tournmanet-system-local2/v1/admin/namespace/{namespace}/tournaments/{tournamentId}/matches/{matchId}/result/admin'.replace('{namespace}', this.namespace).replace('{tournamentId}', tournamentId).replace('{matchId}', matchId)     
    const resultPromise = this.axiosInstance.post(url, data, {params})
