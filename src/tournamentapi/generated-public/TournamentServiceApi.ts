...
export function TournamentServiceApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
  ...
  async function getTournaments( queryParams?: {limit?: number, offset?: number, status?: 'TOURNAMENT_STATUS_UNSPECIFIED' | 'TOURNAMENT_STATUS_DRAFT' | 'TOURNAMENT_STATUS_ACTIVE' | 'TOURNAMENT_STATUS_STARTED' | 'TOURNAMENT_STATUS_COMPLETED' | 'TOURNAMENT_STATUS_CANCELLED', startDateFrom?: string | null, startDateTo?: string | null}): Promise<AxiosResponse<TournamentListTournamentsResponse>> {
  ...
  async function getMatches_ByTournamentId(tournamentId:string,  queryParams?: {round?: number}): Promise<AxiosResponse<TournamentGetTournamentMatchesResponse>> {
    const $ = new TournamentService$(axiosInstance, namespace, useSchemaValidation)
  ...
  async function createRegister_ByTournamentId(tournamentId:string, data: TournamentServiceRegisterForTournamentBody): Promise<AxiosResponse<TournamentRegisterForTournamentResponse>> {
    const $ = new TournamentService$(axiosInstance, namespace, useSchemaValidation)
  ...
  async function getParticipants_ByTournamentId(tournamentId:string,  queryParams?: {pageSize?: number, pageToken?: string | null}): Promise<AxiosResponse<TournamentGetTournamentParticipantsResponse>> {
    const $ = new TournamentService$(axiosInstance, namespace, useSchemaValidation)
  ...
  async function getMatche_ByTournamentId_ByMatchId(tournamentId:string, matchId:string): Promise<AxiosResponse<TournamentGetMatchResponse>> {
    const $ = new TournamentService$(axiosInstance, namespace, useSchemaValidation)
