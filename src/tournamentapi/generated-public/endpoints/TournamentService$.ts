 ...
 * AUTO GENERATED
 */
import { Response, SDKRequestConfig, Validate } from '@accelbyte/sdk'
...
export class TournamentService$ {
  ...
  getTournament_ByTournamentId(tournamentId:string): Promise<Response<TournamentGetTournamentResponse>> {
    ...
    const url = '/v1/public/namespace/{namespace}/tournaments/{tournamentId}'.replace('{namespace}', this.namespace).replace('{tournamentId}', tournamentId)     
    const resultPromise = this.axiosInstance.get(url, {params})
  ...
  getMatches_ByTournamentId(tournamentId:string,  queryParams?: {round?: number}): Promise<Response<TournamentGetTournamentMatchesResponse>> {
    ...
    const url = '/v1/public/namespace/{namespace}/tournaments/{tournamentId}/matches'.replace('{namespace}', this.namespace).replace('{tournamentId}', tournamentId)     
    const resultPromise = this.axiosInstance.get(url, {params})
  ...
  createRegister_ByTournamentId(tournamentId:string, data: TournamentServiceRegisterForTournamentBody): Promise<Response<TournamentRegisterForTournamentResponse>> {
    const params = {} as AxiosRequestConfig
    const url = '/v1/public/namespace/{namespace}/tournaments/{tournamentId}/register'.replace('{namespace}', this.namespace).replace('{tournamentId}', tournamentId)     
  ...
  getParticipants_ByTournamentId(tournamentId:string,  queryParams?: {pageSize?: number, pageToken?: string | null}): Promise<Response<TournamentGetTournamentParticipantsResponse>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/v1/public/namespace/{namespace}/tournaments/{tournamentId}/participants'.replace('{namespace}', this.namespace).replace('{tournamentId}', tournamentId)     
    const resultPromise = this.axiosInstance.get(url, {params})
  ...
  getMatche_ByTournamentId_ByMatchId(tournamentId:string, matchId:string): Promise<Response<TournamentGetMatchResponse>> {
    const params = {} as AxiosRequestConfig
    const url = '/v1/public/namespace/{namespace}/tournaments/{tournamentId}/matches/{matchId}'.replace('{namespace}', this.namespace).replace('{tournamentId}', tournamentId).replace('{matchId}', matchId)     
    const resultPromise = this.axiosInstance.get(url, {params})
