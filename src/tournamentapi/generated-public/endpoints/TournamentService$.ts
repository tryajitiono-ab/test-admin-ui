...
this.useSchemaValidation = useSchemaValidation
  ...
  getTournaments( queryParams?: {limit?: number, offset?: number, status?: 'TOURNAMENT_STATUS_UNSPECIFIED' | 'TOURNAMENT_STATUS_DRAFT' | 'TOURNAMENT_STATUS_ACTIVE' | 'TOURNAMENT_STATUS_STARTED' | 'TOURNAMENT_STATUS_COMPLETED' | 'TOURNAMENT_STATUS_CANCELLED', startDateFrom?: string | null, startDateTo?: string | null}): Promise<Response<TournamentListTournamentsResponse>> {
    ...
    const url = '/ext-abtesttryaji2026033001-demotournament-tournament-system/v1/public/namespace/{namespace}/tournaments'.replace('{namespace}', this.namespace)     
  ...
  getTournament_ByTournamentId(tournamentId:string): Promise<Response<TournamentGetTournamentResponse>> {
    ...
    const url = '/ext-abtesttryaji2026033001-demotournament-tournament-system/v1/public/namespace/{namespace}/tournaments/{tournamentId}'.replace('{namespace}', this.namespace).replace('{tournamentId}', tournamentId)     
    const resultPromise = this.axiosInstance.get(url, {params})
  ...
  getMatches_ByTournamentId(tournamentId:string,  queryParams?: {round?: number}): Promise<Response<TournamentGetTournamentMatchesResponse>> {
    ...
    const url = '/ext-abtesttryaji2026033001-demotournament-tournament-system/v1/public/namespace/{namespace}/tournaments/{tournamentId}/matches'.replace('{namespace}', this.namespace).replace('{tournamentId}', tournamentId)     
    const resultPromise = this.axiosInstance.get(url, {params})
  ...
  createRegister_ByTournamentId(tournamentId:string, data: TournamentServiceRegisterForTournamentBody): Promise<Response<TournamentRegisterForTournamentResponse>> {
    const params = {} as AxiosRequestConfig
    const url = '/ext-abtesttryaji2026033001-demotournament-tournament-system/v1/public/namespace/{namespace}/tournaments/{tournamentId}/register'.replace('{namespace}', this.namespace).replace('{tournamentId}', tournamentId)     
  ...
  getParticipants_ByTournamentId(tournamentId:string,  queryParams?: {pageSize?: number, pageToken?: string | null}): Promise<Response<TournamentGetTournamentParticipantsResponse>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/ext-abtesttryaji2026033001-demotournament-tournament-system/v1/public/namespace/{namespace}/tournaments/{tournamentId}/participants'.replace('{namespace}', this.namespace).replace('{tournamentId}', tournamentId)     
    const resultPromise = this.axiosInstance.get(url, {params})
  ...
  getMatche_ByTournamentId_ByMatchId(tournamentId:string, matchId:string): Promise<Response<TournamentGetMatchResponse>> {
    const params = {} as AxiosRequestConfig
    const url = '/ext-abtesttryaji2026033001-demotournament-tournament-system/v1/public/namespace/{namespace}/tournaments/{tournamentId}/matches/{matchId}'.replace('{namespace}', this.namespace).replace('{tournamentId}', tournamentId).replace('{matchId}', matchId)     
    const resultPromise = this.axiosInstance.get(url, {params})
